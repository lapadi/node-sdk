...
export class Cache implements CacheInterface {
   ...
   */
  public clear(key?: string | RegExp, log?: any): void {
    if (!key) {
   ...
   */
  public get<T>(key: string, log?: any): T | undefined;
  public get<T>(key: string, q: (() => T) | (() => Promise<T>), ttlSec?: number, log?: any): Promise<T>;
  public get<T>(
    key: string,
    q?: (() => T) | (() => Promise<T>) | undefined | any,
    ttlSec?: number,
    log?: any
   ...
   */
  protected log(level: keyof any, msg: string, _log?: any | undefined) {
